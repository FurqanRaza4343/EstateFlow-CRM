...
export default function ContactsModule({ 
  ...
  const [whatsappModal, setWhatsappModal] = useState<{ contact: ContactPerson; open: boolean; message: string; sending: boolean } | null>(null);

  // Action bypass simulator triggers
  const triggerWhatsAppBypass = (contact: ContactPerson) => {
    setWhatsappModal({ contact, open: true, message: `Hi ${contact.firstName}, regarding our real estate listings conversation...`, sending: false });
  };
